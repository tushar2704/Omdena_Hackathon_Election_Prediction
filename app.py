...
st.set_page_config(page_title="US Election 2024 False News Predictor", page_icon="🇺🇸", layout="wide")

# Add a sidebar with information
st.sidebar.title("About")
st.sidebar.info(
    "This app uses AI agents to analyze news articles related to the US 2024 election "
...
st.title("US Election 2024 False News Predictor")
